                  ...
                  if($usuario->rowCount() > 0){
                    ...
                    foreach($usuario->fetchAll() as $usuarios){
                      ...
                      //$candidato["qt_votos"] > 0
                        ...
                        //votar desabilitado
                        echo " <a class=\"btn btn-success btn-block disabled \" href=\"processa/proc_voto_senador1.php?id=\"\"\" role=\"button\" ><i  class=\"material-icons\"  >how_to_vote</i></a>";
                        //remover
                      ...
                      //votar
                      echo " <a class=\"btn btn-success btn-block\" href=\"processa/proc_voto_senador1.php?id=".$candidato["id"]."\" role=\"button\" ><i  class=\"material-icons\"  >how_to_vote</i></a>";
                    }
                }
            }
            ?>  
