...
$sql = "SELECT * FROM candidatos WHERE cargo = 'governador'  ";
$sql = $pdo->query($sql);
              ...
              <div class=\"card-body\">
                  ...
                  if($usuario->rowCount() > 0){
                    ...
                    foreach($usuario->fetchAll() as $usuarios){
                      // switch (($usuarios['voto_governador'] ) AND  ($candidato["qt_votos"])) {
                        
                      //   case (($usuarios['voto_governador'] >= 1 ) AND  ($candidato["qt_votos"] > 0)):
                      //       echo "i equals 0";
                      //       break;
                      //   case (($usuarios['voto_governador'] >= 1 ) AND  ($candidato["qt_votos"] < 0)):
                      //       echo "i equals 1";
                      ...
                      if ($usuarios['voto_governador'] >= 1)  {               
                      //$candidato["qt_votos"] > 0
                    
                        //votar desabilitado
                        echo " <a class=\"btn btn-success btn-block disabled \" href=\"processa/proc_voto_governador.php?id=\"\"\" role=\"button\" ><i  class=\"material-icons\"  >how_to_vote</i></a>";
                        //remover
                      ...
                      //votar
                      echo " <a class=\"btn btn-success btn-block\" href=\"processa/proc_voto_governador.php?id=".$candidato["id"]."\" role=\"button\" ><i  class=\"material-icons\"  >how_to_vote</i></a>";
                    }
                }
            }
            ?>  
